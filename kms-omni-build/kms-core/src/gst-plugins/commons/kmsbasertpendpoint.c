...
//  self->priv = KMS_BASE_RTP_ENDPOINT_GET_PRIVATE (self);
  self->priv = kms_base_rtp_endpoint_get_instance_private (self);
  ...
  g_type_interface_add_prerequisite (KMS_TYPE_BASE_RTP_ENDPOINT, KMS_TYPE_I_RTP_SESSION_MANAGER);
      g_type_add_interface_static (KMS_TYPE_BASE_RTP_ENDPOINT, KMS_TYPE_I_RTP_SESSION_MANAGER,
                                   &(const GInterfaceInfo) {
                                       (GInterfaceInitFunc) kms_i_rtp_session_manager_interface_init,
                                       NULL,
                                       NULL
                                   });
}
